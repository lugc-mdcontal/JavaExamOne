...
public class DBUtility {
    ...
    public static ArrayList<Employee> getEmployees() throws SQLException {
        ...
        while (resultSet.next())
            employees.add(new Employee(resultSet.getInt("employeeId"), resultSet.getString("firstName"), resultSet.getString("lastName"), resultSet.getString("phoneNumber"), resultSet.getDate("hireDate"), resultSet.getString("jobCode")));
